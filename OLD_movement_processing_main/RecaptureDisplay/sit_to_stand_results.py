...
try:
    from ..ActivityAnalyses.sit_to_stand_analysis import sit_to_stand_analysis
except ImportError:
    from movement_processing_main.ActivityAnalyses.sit_to_stand_analysis import sit_to_stand_analysis
