...
try:
    from ..ActivityAnalyses.ergo_rowing_analysis import ergo_rowing_analysis
    from .segment_events import build_bilateral_segment_events_from_cycle
except ImportError:
    from movement_processing_main.ActivityAnalyses.ergo_rowing_analysis import ergo_rowing_analysis
    from movement_processing_main.RecaptureDisplay.segment_events import build_bilateral_segment_events_from_cycle
